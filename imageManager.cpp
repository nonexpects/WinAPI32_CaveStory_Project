...
void imageManager::frameRender(string strKey, HDC hdc, int destX, int destY, int sourceX, int sourceY, int sourceWidth, int sourceHeight, int frameX, int frameY)
{
	//이미지 찾아서 그냥 이미지클래스의 함수를 실행한다
	image* img = findImage(strKey);
	if (img) img->frameRender(hdc, destX, destY, sourceX, sourceY, sourceWidth, sourceHeight, frameX, frameY);
}

void imageManager::frameRender(string strKey, HDC hdc, int destX, int destY, int sourceX, int sourceY, int sourceWidth, int sourceHeight, int frameX, int frameY, int currentFrameX, int currentFrameY)
{
	//이미지 찾아서 그냥 이미지클래스의 함수를 실행한다
	image* img = findImage(strKey);
	if (img) img->frameRender(hdc, destX, destY, sourceX, sourceY, sourceWidth, sourceHeight, frameX, frameY, currentFrameX, currentFrameY);
}

void imageManager::frameAlphaRender(string strKey, HDC hdc, int destX, int destY, int sourceX, int sourceY, int sourceWidth, int sourceHeight, int frameX, int frameY, BYTE alpha)
{
	//이미지 찾아서 그냥 이미지클래스의 함수를 실행한다
	image* img = findImage(strKey);
	if (img) img->frameAlphaRender(hdc, destX, destY, sourceX, sourceY, sourceWidth, sourceHeight, frameX, frameY, alpha);
}
